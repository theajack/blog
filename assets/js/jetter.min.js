  ...
  window.J = {
    ...
    jsonp: function(options) {
      if (!options.url) {
        ...
        options.time = _checkArg(options.callback, 5000);
...
(function(){
    ...
    input: function(c, d, e) {
      ...
      if (c.constructor == String) {
        ...
        if (c.text == undefined || c.text.constructor == String) {
          _appendOneInput(c.text, a, b)
        } else {
          for (var i = 0; i < c.text.length; i++) {
            _appendOneInput(_checkArg(c.text[i], (this.language == "CHINESE") ? "请输入：" : "Please input:"), a[i], b[i])
          }
        }
  ...
  function _appendOneInput(a, b, c) {
    if (arguments.length == 1) {
      b = a.
    default;
      c = a.valid;
  ...
  function _getElemsObj(d, b) {
    ...
    var c = {};
    a.each(function(e) {
      c[e.attr(b)] = _getContentForGet(e)
    });
    return c
  };
